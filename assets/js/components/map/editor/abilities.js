...
Vue.component('activeAbility', {
  ...
  template: ['<div class="ability flex flex-top">',
      '<div>',
        ...
        '<div class="field-row">',
          '<label>Level:</label> ',
          '<input type="number" v-model="ability.level" />',
        '</div>',

        '<div class="field-row">',
          '<label>Cooldown:</label> ',
          '<input type="number" v-model="ability.cooldown" />',
        '</div>',

        '<div class="field-row">',
          '<label>Heal:</label> ',
          '<input type="number" v-model="ability.heal" />',
        '</div>',

        '<div class="field-row">',
          '<label>Damage:</label> ',
          '<input type="number" v-model="ability.damage" />',
        '</div>',

        '<div class="field-row" v-if="ability.type != \'damage\' && ability.type != \'heal\' && ability.type != \'escape\'">',
          '<label>Time:</label> ',
          '<input type="number" v-model="ability.time" />',
        '</div>',

        '<div class="field-row" v-if="ability.type == \'heal_buff\'">',
          '<label>Heal Tick:</label> ',
          '<input type="number" v-model="ability.heal_tick" />',
        '</div>',

        '<div class="field-row" v-if="ability.type == \'damage_dot\'">',
          '<label>Damage Tick:</label> ',
          '<input type="number" v-model="ability.damage_tick" />',
        '</div>',

        '<div class="field-row" v-if="ability.type == \'damage_dot\' || ability.type == \'damage\' || ability.type == \'damage_aoe\'">',
          '<label>Strength Scaling:</label> ',
          '<input type="number" v-model="ability.strength_scaling" />',
        '</div>',

        '<div v-if="ability.type == \'damage_aoe\'">',
          '<div class="field-row">',
            '<label>Damage Aoe:</label> ',
            '<input type="number" v-model="ability.damage_aoe" />',
          '</div>',

          '<div class="field-row">',
            '<label>Damage Count:</label> ',
            '<input type="number" v-model="ability.damage_count" />',
          '</div>',
        '</div>',
        ...
        '<div v-if="ability.type == \'buff\' || ability.type == \'debuff\'">',
          '<div class="field-row">',
            '<label>Stamina:</label> ',
            '<input type="number" v-model="ability.stamina" />',
          '</div>',

          '<div class="field-row">',
            '<label>Strength:</label> ',
            '<input type="number" v-model="ability.strength" />',
          '</div>',

          '<div class="field-row">',
            '<label>Agility:</label> ',
            '<input type="number" v-model="ability.agility" />',
          '</div>',

          '<div class="field-row">',
            '<label>Defence:</label> ',
            '<input type="number" v-model="ability.defence" />',
          '</div>',
        '</div>',

        '<div class="field-row" v-if="ability.type == \'escape\'">',
          '<label>Chance:</label> ',
          '<input type="number" v-model="ability.chance" />',
        '</div>',
      '</div>',
    '</div>'
  ].join(""),
